  ...
  return (
    <div className="container mt-5">
      ...
      <div className="text-end mb-2">
        <a href="#" className="text-primary text-decoration-none small">Ver listado</a>
      </div>
      ...
      <div className="p-4 rounded shadow-sm" style={{ backgroundColor: '#e0e0e0', minHeight: '400px' }}>
        ...
        {libros.length === 0 ? (
            <p className="text-center text-muted mt-5">No hay libros cargados aún.</p>
        ) : (
                ...
                {libros.map((libro) => (
                    <div className="col" key={libro._id}>
                        ...
                        <div className="card h-100 border-0 shadow-sm">
                            ...
                            {/* Imagen Portada */}
                            <div style={{ height: '250px', overflow: 'hidden' }} className="bg-light d-flex align-items-center justify-content-center">
                                {libro.portada_url ? (
                                    <img 
                            ...
                            <div className="card-body p-2 text-center">
                                <h6 className="card-title text-truncate small mb-3">{libro.titulo}</h6>
